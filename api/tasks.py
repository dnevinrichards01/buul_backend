...
import time
from plaid.model import ItemPublicTokenExchangeRequest, ItemPublicTokenExchangeResponse
...
def plaid_item_public_token_exchange(kwargs):
    ...
    try:
        serializer = ItemPublicTokenExchangeResponseSerializer(
...
def plaid_item_public_token_exchange(kwargs):
    ...
    try:
        ...
        userPlaidInfo = UserPlaidInfo(user = user)
        userPlaidInfo.accessToken = validated_data['access_token']
        userPlaidInfo.itemId = validated_data['item_id']
        userPlaidInfo.save()
